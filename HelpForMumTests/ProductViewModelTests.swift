...
class ProductViewModelTests: XCTestCase {
    ...
    func test_ProductViewModel_AddProduct() {
        ...
        let product = product_vm.addProduct(name: name)[0]
    ...
    func test_ProductViewModel_sortProductsForFoodIntake() {
        ...
        let product1 = product_vm.addProduct(name: name1)[0]
        
        let name2 = UUID().uuidString
        let product2 = product_vm.addProduct(name: name2)[0]
        ...
        XCTAssertEqual(product1.name, name1)
        XCTAssertEqual(product2.name, name2)
