    ...
    struct MealView: View {
        var body: some View {
            VStack {
                ...
                Text("")
                Text("Если вы хотите добавить продукт в блюдо, то нажмите 'Добавить продукты'. Выберите продукты из списка, нажав на них. Если продукта, которого вы хотите добавить, нет, то напишите его название в поле поиска и нажмите '+', в списке он не появится, так как сразу будет в списке добавленных продуктов.")
                Text("")
                Text("Добавление в приём пищи")
                    .bold()
                    .font(.headline)
                Text("")
        ...
        var body: some View {
            VStack {
                ...
                Text("Совет 1:")
                    ...
                    .font(.title2)
                Text("")
                Text("Для первых достоверных результатов анлитики, нужно вести пищевой дневник как минимум 3-4 дня.")
                Text("")
                Text("Совет 2:")
                    .bold()
                    .font(.title2)
                Text("После выведения проблемного продукта из рациона, попытайтесь снова его ввести через 3-4 недели.")
                Text("")
                Text("Совет 3:")
                    .bold()
                    .font(.title2)
